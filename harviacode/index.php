...
<html>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">Codeigniter CRUD Generator</h3>
                ...
                <p><strong>Copyright &COPY; <? echo date('Y'); ?> <a target="_blank" href="http://harviacode.com">Harviacode</a></strong></p>
            </div>
        </div>
