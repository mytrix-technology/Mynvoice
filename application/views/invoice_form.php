                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <table class='table table-bordered'>
                                        ...
                                        <tr><td>Kode Quotation <?php echo form_error('kdquo') ?></td>
                                            <td>
                                            <?php echo cmb_dinamis('kdquo','quotation','kdquo','kdquo',$kdquo); ?>
                                        </td>
                                        <tr><td>Order Number <?php echo form_error('ordernumber') ?></td>
                                            <td><input type="text" class="form-control" name="ordernumber" id="ordernumber" placeholder="ordernumber" value="<?php echo $ordernumber; ?>" />
                                        </td>
                                        <input type="hidden" name="kdinv" value="<?php echo $kdinv; ?>" /> 
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <table class='table table-bordered'>
                                        <tr><td>Invoice Date <?php echo form_error('invdate') ?></td>
                                            <td><input type="text" class="form-control" name="invdate" id="datepicker1" data-format="dd-mm-yyyy" placeholder="Invdate" value="<?php echo $invdate; ?>" />
                                        </td>
                                        ...
                                        <tr><td>Due Date <?php echo form_error('duedate') ?></td>
                                            <td><input type="text" class="form-control" name="duedate" id="datepicker" data-format="dd-mm-yyyy" placeholder="Invdate" value="<?php echo $invdate; ?>" />
                                        </td>
