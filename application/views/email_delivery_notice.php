            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Email to Mr/Mrs/PT <?php echo $custkd; ?> - Delivery Notice No <?php echo $kddelnot; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <textarea name="pesan" id="compose-textarea" class="form-control" style="height: 300px">
                      ...
                      <p>
                        Your estimate <?php echo $kddelnot; ?> can be viewed, printed or downloaded as PDF from the link below.
                        Click to view Delivery Notice
                  ...
                  <input type="hidden" name="kdform" id="kdform" value="<?php echo $kddelnot; ?>" />
                </div><!-- /.box-body -->
