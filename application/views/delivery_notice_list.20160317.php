	    ...
	    <tbody>
		    ...
		    <td><?php echo ($delivery_notice->status == 0 ? "On Process" : "Delivered"); ?></td>
		    <td style="text-align:center" width="140px">
			<?php 
			echo anchor(site_url('delivery_notice/read/'.$delivery_notice->kddelnot),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-danger btn-sm')); 
			echo '  '; 
			echo anchor(site_url('delivery_notice/update/'.$delivery_notice->kddelnot),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-danger btn-sm')); 
			//echo '  '; 
			//echo anchor(site_url('delivery_notice/delete/'.$delivery_notice->kddelnot),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
