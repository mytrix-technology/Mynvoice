<!-- Main content -->
	    ...
	    <tr><td>Is Active <?php echo form_error('is_active') ?></td>
                <td><?php echo form_dropdown('is_active',array('1'=>'AKTIF','0'=>'TIDAK AKTIF'),$is_active,"class='js-example-basic-single js-states form-control'");?>
        </td>
	    <tr><td>Is Parent <?php echo form_error('is_parent') ?></td>
            <td>
                <select name="is_parent" class="js-example-basic-single js-states form-control">
