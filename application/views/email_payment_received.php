            ...
            <form action="<?php echo $action; ?>" method="post">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Email to Mr/Mrs/PT <?php echo $custkd; ?> - Payment Received No <?php echo $kdpayrec; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <textarea name="pesan" id="compose-textarea" class="form-control" style="height: 300px">
                      ...
                      <p>
                        Your Payment Received Number <?php echo $kdpayrec; ?> can be viewed, printed or downloaded as PDF from the link below.
                  ...
                  <input type="hidden" name="kdform" id="kdform" value="<?php echo $kdpayrec; ?>" />
                </div><!-- /.box-body -->
