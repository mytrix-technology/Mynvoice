...
class Nota extends CI_Controller
{
    ...
    public function create() 
    {
        $data = array(
            ...
            'ppn' => set_value('ppn'),
    	    'shipcharge' => set_value('shipcharge'),
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
             $data = array(
                ...
                'shipcharge' => $this->input->post('shipcharge',TRUE),
            ...
            //var_dump(serialize($datadetail));die;
    ...
    function pdf()
    {
        ...
        $html = $this->load->view('nota_pdf', $data, true);
        $pdf = new mPDF('en-GB','A6-L');
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-01-25 23:29:54 */
/* http://harviacode.com */